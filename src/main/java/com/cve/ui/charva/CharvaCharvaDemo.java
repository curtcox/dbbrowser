...
final class CharvaCharvaDemo
        extends JFrame
        implements ActionListener {

    private static final Log LOG = Logs.of();

    public CharvaCharvaDemo() {
    ...
    public static void main(String[] args) {
        CharvaCharvaDemo testwin = new CharvaCharvaDemo();
        testwin.show();
    }
...
//	    (new JFileChooser()).show();
    ...
    private static final class TaskThread extends Thread {
         ...
         * Constructor
         */
        private TaskThread(JProgressBar bar) {
     ...
     * Swing" subsection.
     */
    private static final class ProgressBarUpdater implements Runnable {
        private int _percent;

        private final JProgressBar _progressBar = null;
 ...
 */
static final class ColorLayoutTest
        extends JDialog
        implements ActionListener {
...
static final class TextWidgetTest
     ...
     */
    final class TextFieldPanel extends JPanel
            implements ItemListener {
