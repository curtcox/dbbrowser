...
final class SwingCharvaDemo
        extends JFrame
        implements ActionListener {

    public SwingCharvaDemo() {
    ...
    public static void main(String[] args) {
        SwingCharvaDemo testwin = new SwingCharvaDemo();
        testwin.show();
    }
 ...
 * are pixels.
 */
static final class NullLayoutTest
        extends JDialog
        implements ActionListener {
 ...
 */
static final class GridBagLayoutTest
        extends JDialog
    ...
    public GridBagLayoutTest(Frame owner_) {
        ...
        scrollpane.setViewportBorder(new TitledBorder("Countries"));
 ...
 */
static final class JTabbedPaneTest
        extends JDialog
    ...
    final class GeneralPane extends JPanel {
        public GeneralPane() {
    ...
    final class DevicePane extends JPanel {
        public DevicePane() {
            setLayout(new BorderLayout());
    ...
    final class PerformancePane extends JPanel {
 ...
 */
static final class TextWidgetTest
        extends JDialog
        implements ActionListener {
     ...
     */
    static final class TextFieldPanel extends JPanel
     ...
     */
    static final class PasswordFieldPanel extends JPanel
            implements ItemListener {
        private JCheckBox _enabled;
        private JCheckBox _visible;
     ...
     */
    static final class TextAreaPanel extends JPanel
            implements ItemListener {
 ...
 */
static final class SelectionTest
        extends JDialog
        implements ActionListener {
     ...
     */
    static final class ComboBoxPanel extends JPanel
            implements ItemListener {
     ...
     */
    final class JListPanel extends JPanel
...
//    private JScrollBar _scrollbar;
    ...
    private JPanel makeCenterPanel() {
        ...
        _table.setPreferredScrollableViewportSize(new Dimension(300, 50));
        //_table.setValueAt("Yellow", 5, 2);
        //_table.setValueAt("Red", 7, 4);
        //_table.setValueAt("Magenta", 1, 5);
        JScrollPane scrollPane = new JScrollPane(_table);
        scrollPane.setViewportBorder(new TitledBorder("The Heavenly Bodies"));
 ...
 * to such KeyEvents.
 */
static final class KeyEventTest
        extends JDialog
        implements ActionListener, KeyListener {
 ...
 */
static final class FocusEventTest
        extends JDialog
 ...
 */
static final class ProgressBarTest
        extends JDialog
        implements ActionListener {
    ...
    private final class TaskThread extends Thread {
        ...
        private final Log logger = Logs.of();
         ...
         * Once per second, wake up and update the progress bar. Note that
     ...
     * instances of this can be passed to the EventQueue.invokeLater() method.
     ...
     * Swing" subsection.
     */
    private final class ProgressBarUpdater implements Runnable {
